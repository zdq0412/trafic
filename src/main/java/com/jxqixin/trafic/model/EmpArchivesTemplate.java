 ...
 */
@Entity
@Table(name = "m55_emp_archives_template")
@GenericGenerator(name="id_gen",strategy = "uuid")
public class EmpArchivesTemplate  implements Serializable {
	@Id
	 ...
	 * 身份证:idcard
	 * 劳动合同:contract
	 * 资质文件:qualificationDocument
	 * 工作经历:jobHistory
	 * 入职培训:inductionTraining
	 * 安全责任书:safetyResponsibilityAgreement
	 * 培训考核情况:trainingExamine
	 * 其他文档:otherDocument
	 * */
	private String type;
	/**备注*/
