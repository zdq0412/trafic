...
create table org(
  ...
  established_time timestamp null comment '成立日期',
...
create table m004_law(
 id varchar(36) primary key comment 'ID主键',
  ...
  publishDate timestamp null comment '发布日期',
  implementDate timestamp null comment '实施日期',
...
create table m019_safety_production_cost_plan_detail(
 id varchar(36) primary key comment 'ID主键',
 billingDate timestamp null comment '开票日期',
...
create table m046_meeting_template(
 ...
 createDate timestamp null comment '模板创建日期',
 meetingName varchar(100) comment '会议名称或主要议题',
 meetingDate timestamp null  comment '开会时间',
 endMeetingDate timestamp null  comment '闭会时间',
...
create table m047_training_template(
 ...
 trainingDate timestamp null  comment '培训时间',
...
create table m042_security_check_template(
  ...
  note varchar(2000) comment '备注',
  createDate timestamp null comment '创建日期',
  checkDate timestamp null comment '安全检查日期',
...
create table m049_danger_goods_check_detial(
  id varchar(36) primary key comment '主键',
  checkDate timestamp null comment '检查日期',
...
create table m011_idcard(
  ...
  createDate timestamp null comment '创建日期',
  beginDate timestamp null comment '起始日期',
  endDate timestamp null comment '终止日期',
  url varchar(2000) comment '文件访问路径',
  realPath varchar(2000) comment '实际存储路径',
   deleted bit default 0  comment '删除标识',
  emp_id varchar(36) comment '所属人员',
